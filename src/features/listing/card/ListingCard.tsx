...
const ListingCard = ({
  ...
  return (
    <div className="group cursor-pointer select-none border border-black/10 shadow-[0px_0px_2px_rgba(0,0,0,0.075)] rounded-xl transition-all duration-200 hover:bg-neutral-50">
      <img
        src={imgSrc}
        alt="Couldn't load the image"
        className="w-full aspect-[1.6/1] rounded-t-lg object-cover object-center group-hover:brightness-90 transition-all duration-200"
        draggable={false}
      />
